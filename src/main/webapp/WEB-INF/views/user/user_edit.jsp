...
<ul class="breadcrumb">
	...
	<div class="block">
        <div class="block-content collapse in">
            <div class="span12">
			<!-- BEGIN FORM-->
			<form action="${root}/vote/${empty vote.id?'addVote':'updateVote'}" id="form_sample_1" class="form-horizontal" target="ajax" novalidate="novalidate">
					...
					<div class="control-group">
						...
						<div class="controls">
								...
								<label style="overflow:hidden;width:100px;">
								  <input type="radio" name="inlineRadioOptions" id="inlineRadio2" value="2">禁用
								</label>		
							  	<!--  	
